...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_LOCKED_USERNAME = "locked_username";
    public static final String EXTRA_LOCK_UNTIL = "lock_until";
            ...
            @Override public void onClick(View v) {
                ...
                if (username.isEmpty() || password.isEmpty()) {
                    Toast.makeText(MainActivity.this,
                            getString(R.string.msg_enter_both),
                ...
                if (now < until) {
                    ...
                    Toast.makeText(MainActivity.this,
                            getString(R.string.msg_locked_remaining, remain),
    ...
    private boolean isValidCredential(String username, String password) {
        if (builtInUsers.containsKey(username) && builtInUsers.get(username).equals(password)) {
            return true;
        }
